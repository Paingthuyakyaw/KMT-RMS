...
const MinorAlarm = () => {
  ...
  const minorCount = useMemo(
    () => fakeMinorAlarm.filter((x) => x.alarmStatus === "Alarm").length,
    [fakeMinorAlarm],
  );
  ...
  return (
    <div className="h-screen">
      <h4 className="text-sm font-semibold">Minor Alarm</h4>
